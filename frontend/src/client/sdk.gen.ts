...
export class RoleDirsService {
     ...
     * @throws ApiError
     */
    public static readRoleDirs(data: RoleDirsReadRoleDirsData = {}): CancelablePromise<RoleDirsReadRoleDirsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static createRoleDir(data: RoleDirsCreateRoleDirData): CancelablePromise<RoleDirsCreateRoleDirResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/role-dirs/',
            body: data.requestBody,
     ...
     * @throws ApiError
     */
    public static readRoleDirById(data: RoleDirsReadRoleDirByIdData): CancelablePromise<RoleDirsReadRoleDirByIdResponse> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static updateRoleDir(data: RoleDirsUpdateRoleDirData): CancelablePromise<RoleDirsUpdateRoleDirResponse> {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/api/v1/role-dirs/{role_dir_id}',
            path: {
     ...
     * @throws ApiError
     */
    public static deleteRoleDir(data: RoleDirsDeleteRoleDirData): CancelablePromise<RoleDirsDeleteRoleDirResponse> {
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/api/v1/role-dirs/{role_dir_id}',
            path: {
